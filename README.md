...
## 📖 Table of Content
  - [Sensing (Total: 319)](#sensing)
    - [Motion Sensing (10/7)](#motion-sensing)
    - [Wireless Sensing (Total: 145)](#wireless-sensing)
    	- [RFID Sensing (29/5)](#rfid-sensing)
    	- [Wi-Fi Sensing (55/20)](#wi-fi-sensing)
    	- [mmWave Sensing (23/13)](#mmwave-sensing)
    	- [TeraHertz Sensing (2/0)](#teraHertz-sensing)
    	- [UWB Sensing (12/2)](#uwb-sensing)
     	- [Cellular Sensing (4/1)](#cellular-sensing)
    	- [LoRa Sensing (4/1)](#lora-sensing)
    	- [Bluetooth Sensing (5/2)](#bluetooth-sensing)
     	- [Aerial Sensing (2/0)](#ariel-sensing)
      	- [NFC Sensing (1/0)](#nfc-sensing)
      	- [RF Sensing (8/5)](#rf-sensing)
    - [Vision Sensing (30/21)](#vision-sensing)
    - [Acoustic Sensing (51/17)](#acoustic-sensing)
    - [Multi-Modal Sensing (37/25)](#multi-modal-sensing)
    - [Earable Sensing (20/7)](#earable-sensing)
    - [Visible Light Sensing (15/1)](#light-sensing)
    - [Magentic Sensing (6/2)](#magnetic-sensing)
    - [Cross-Medium Sensing (2/0)](#cross-medium-sensing)
  ...
  - [Computing (Total: 154)](#computing)
    - [On-Device Inference ](#on-device-inference)
      	...
      	- [Runtime Adaptation (8)](#runtime-adaptation)
    - [Offloading (15)](#offloading)
      - [Model Partitioning](#model-partitioning)
      - [Workload Partitioning (5)](#workload-partitioning)
      - [Communication Optimization (5)](#communication-optimization)   
      - [Privacy-Preserving Offloading (5)](#privacy-preserving-offloading)
  ...
  - [Networking and Communication](#networking-and-communication)
    - [Battery (Total: 221 | No ML(188) | ML(12) | DL(21))](#user-content-battery)
      - [Cellular (Total:49  | No ML(37) | ML(4) | DL(8))](#user-content-cellular)
      - [WiFi (Total: 15 | No ML(12) | ML(1) | DL(2))](#user-content-wifi)
      - [Acoustic (Total: 9 | No ML(8) | ML(0) | DL(1))](#user-content-acoustic)
      - [Visible Light (Total: 17 | No ML(14) | ML(0) | DL(3))](#user-content-visible-Light)
      - [Bluetooth (Total: 4 | No ML(4) | ML(0) | DL(0))](#user-content-bluetooth)
      - [Millimeter-Wave (Total: 25 | No ML(23) | ML(2) | DL(0))](#user-content-millimeter-Wave)
      - [UWB (Total: 5 | No ML(5) | ML(0) | DL(0))](#user-content-uwb)
      - [TV Whitespace (Total: 5 | No ML(5) | ML(0) | DL(0))](#user-content-tv-whitespace)
      - [LoRa/LoRaWAN (Total: 24 | No ML(17) | ML(3) | DL(4))](#user-content-loralorawan)
      - [LPWAN (Total: 13 | No ML(12) | ML(0) | DL(1))](#user-content-lpwan)
      - [SDR (Total: 7 | No ML(7) | ML(0) | DL(0))](#user-content-sdr)
      - [CTC (Total: 23 | No ML(23) | ML(0) | DL(0))](#user-content-ctc)
      - [... (Total: 25 | No ML(21) | ML(2) | DL(2))](#user-content-other-sensor-network)
    - [Batteryless (Total: 100 | No ML(93) | ML(4) | DL(3))](#user-content-batteryless)
      - [LoRa (Total: 9 | No ML(9) | ML(0) | DL(0))](#user-content-lora)
      - [Millimeter-Wave (Total: 4 | No ML(4) | ML(0) | DL(0))](#user-content-millimeter-wave-1)
      - [WiFi (Total: 17 | No ML(17) | ML(0) | DL(0))](#user-content-wifi-1)
      - [RFID (Total: 12 | No ML(12) | ML(0) | DL(0))](#user-content-rfid)
      - [Visible Light Total: 12 | No ML(10) | ML(0) | DL(2))](#user-content-visible-Light-1)
      - [Acoustic (Total: 5 | No ML(5 | ML(0) | DL(0))](#user-content-acoustic-1)
      - [... (Total: 41 | No ML(36) | ML(4) | DL(1))](#user-content-other-batteryless-works)
    - [Hybrid (2/0)](#hybrid)
    - [Others (6/3)](#na) 
  - [Domain-specific AIoT Systems (Total: 209)](#domain-specific-aiot-systems)
    ...
    - [AIoT Systems for AR/VR/MR (Total: 35 | No ML(19) | ML(4) | DL(12))](#aiot-systems-for-arvrmr)
...
* Understanding WiFi signal frequency features for position-independent gesture sensing, IEEE Transactions on Mobile Computing 2022 [[Paper]](https://hal.science/hal-03363402/file/Understanding_WiFi_Signal_Frequency_Features_for_Position-Independent_Gesture_Sensing.pdf) (NO ML)
...
* Your Table Can Be an Input Panel: Acoustic-based Device-Free Interaction Recognition, IMWUT 2019 [[Paper]](https://dl.acm.org/doi/abs/10.1145/3314390) (DL)
