...
## 📖 Table of Content
  ...
  - [Networking and Communication (Total: 339)](#networking-and-communication)
...
## Networking and Communication (339)
...
#### 💡 Visible Light (Total:  | No ML() | ML() | DL())
...
#### 〰️ Millimeter-Wave (Total:  | No ML() | ML() | DL())
...
#### TV Whitespace (Total:  | No ML() | ML() | DL())
...
#### LoRa/LoRaWAN (Total:  | No ML() | ML() | DL())
...
##### Multi-band Operation (Total:  | No ML() | ML() | DL())
...
#### Millimeter-Wave (Total:  | No ML() | ML() | DL())
...
#### Other Batteryless Works (Total:  | No ML() | ML() | DL())
