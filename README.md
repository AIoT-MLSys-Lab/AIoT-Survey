...
Majority of the included papers are published at top-tier venues in the areas of mobile computing (MobiCom/MobiSys/SenSys), networks (SIGCOMM/NSDI), computer systems (OSDI/SOSP/ASPLOS), and AI/ML systems (MLSys) from 2016 to now. **We will actively maintain this list to include newly published work**.
  ...
  - [Computing (140)](#computing)
    - [On-Device Inference (61)](#on-device-inference)
      	...
      	- [Inference Optimization (15)](#inference-optimization)
      	- [Multi-Tenant Inference (11)](#multi-tenant-inference)
      	- [Cross-Processor Inference (10)](#cross-processor-inference)
      	- [Privacy-Preserving Inference (5)](#privacy-preserving-inference)
      	- [Adaptation (6)](#adaptation)
      	- [Benchmarks (2)](#inference-benchmarks)
    - [On-Device Training (34)](#on-device-training)
    	- [Training on a Single Device (10)](#training-on-a-single-device)
    	- [Training on Distributed Devices (2)](#training-on-distributed-devices)
    	- [Cross-Device Federated Learning (18) (Samiul)](#cross-device-federated-learning)
...
### AIoT Systems for Healthcare and Wellbeing (Total: 38)	
...
* Transparent AR Processing Acceleration at the Edge, EuroSys 19 [[Paper]](https://dl.acm.org/doi/pdf/10.1145/3301418.3313942)
...
### AIoT Systems for Agriculture  (Total: 9)
...
### AIoT Systems for Biology (Total: 6)
