...
Majority of the included papers are published at top-tier venues in the areas of mobile computing (MobiCom/MobiSys/SenSys), networks (SIGCOMM/NSDI), computer systems (OSDI/SOSP/ASPLOS/EuroSys/ATC), and AI/ML systems (MLSys) from 2016 to now. We will keep updating this list to include newly published papers.

  - [Sensing (Lead by MZ)](#sensing-mobicom-mobisys-sensys-nsdi)
  ...
  - [Computing (Lead by MZ)](#computing)
  ...
  - [Power (Lead by Zhichao)](#power)
  - [Security and Privacy (Lead by Zhichao)](#security-and-privacy)
  - [AIoT Systems and their Applications (Lead by MZ)](#aiot-systems-and-their-applications)
