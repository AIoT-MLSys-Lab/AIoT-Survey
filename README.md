...
```diff
+ In-Orchard Localization with a Single LoRa Gateway and Generative Model-based Efficient Fingerprinting, MobiSys 4 [[Paper]](https://dl.acm.org/doi/10.1145/3643832.3661876) (DL)
